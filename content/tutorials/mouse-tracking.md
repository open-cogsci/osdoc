...
:--
cmd: figure
src: osmt_trial_loop.png
caption:Defining stimuli
--:
...
In our case, it's actually easier to edit the `logger` script (click the ![icon](img/mouse-tracking/osmt_scripticon.png)) than to use the GUI, like so:
