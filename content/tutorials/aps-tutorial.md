...
::1.png::Lexical-decision times are lowest when participants fixate slightly to the left of the word center. In this example, using 7 (blue) and 5 (orange) letter words, the size of this effect is about 0.63 and 0.70 in letter units. [(Adapted from Brysbaert & Nazir, 2005)](#references).
...
::2.png::Schematic example of the trial sequence.
...
::3.png::The OpenSesame window on start-up.
...
::4.png::The structure of the 'Extended template' as seen in the overview area.
...
::5.png::An example of variables defined in a loop table. (This example is not related to the experiment created in this tutorial.)
...
::6.png::An example of a `sequence` item used as a trial sequence. (This example is not related to the experiment created in this tutorial.)
...
::7.png::The loop wizard quickly generates full-factorial designs.
...
::8.png::The loop table after you have manually added the `correct_response` variable.
...
::9.png::Your *trial_sequence* after you have added two new sketchpads.
...
::10.png::Your *trial_sequence* after you have give the new sketchpads more informative names.
...
::12.png::A `sketchpad` item with fixation bars and a 1000 ms duration.
...
::13.png::The text drawing-tool of the `sketchpad` item.
...
::14.png::Text in a `sketchpad` item. The square brackets indicate that 'word' should be interpreted as a variable name.
...
::15.png::A string of five hash-tags is used for the mask.
...
::16.png::The `keyboard_response` item.
...
::17.png::The file-pool selection dialog.
...
::18.png::The `form_consent` plug-in.
