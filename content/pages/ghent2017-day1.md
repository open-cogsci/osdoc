title: Ghent 2017 workshop (day 1)
...
A two-day workshop will take place at the University of Ghent. This booklet is for Day 1.

The Day 1 workshop consists of two main parts. In the first part, corresponding to the Tutorial below, we will create a complete experiment together. In the second part, corresponding to the Extra assignments below, the workshop participants improve this experiment by themselves, based on a few suggestions.
