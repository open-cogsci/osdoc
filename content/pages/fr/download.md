...
OpenSesame est actuellement construit et testé avec Python 3.11. D'autres versions de Python >=3.7 fonctionnent mais ne sont pas testées de manière exhaustive. Python 2 n'est plus supporté. La dernière version qui incluait un paquet Python 2 était la 3.3.12, qui peut encore être téléchargée depuis l'[archive des releases](https://github.com/open-cogsci/OpenSesame/releases/tag/release%2F3.3.12).
