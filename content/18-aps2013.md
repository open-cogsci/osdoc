...
This OpenSesame workshop will be presented at the 25th annual convention of the Association for Psychological Science (APS). The workshop will take place May 26, 2013, 11:00PM - 13:20PM. The workshop is co-sponsored by the Society of Multivariate Experimental Psychology ([SMEP][]).
...
- The primary resource for the workshop is this page, which can be downloaded in `.pdf` format from [here][pdf].
